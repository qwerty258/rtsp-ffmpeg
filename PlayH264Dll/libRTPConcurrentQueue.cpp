...
{
    concurrent_queue_context* queue_context = (concurrent_queue_context*)calloc(1, sizeof(concurrent_queue_context));
...
bool concurrent_queue_pushback(concurrent_queue_handle handle, void* element)
{
    ...
    concurrent_queue_node* node = (concurrent_queue_node*)calloc(1, sizeof(concurrent_queue_node));
    if(NULL == node)
    {
        return false;
    }
